...
const Footer = () => {
  return (
    <div className="mx-auto max-w-2xl lg:max-w-4xl px-4 sm:px-6 lg:px-8 py-4">
      <div className="flex flex-row justify-between border-t border-black/10 py-2">
        <div className="mt-1.5">
          <p className="text-xs">
            <a
              href="https://fraight.online"
              className="font-bold text-black/50 hover:text-black transition mr-1"
            >
              Fraight
            </a>
          ...
          <div>
            <a href="https://github.com/fraightonline" target="_blank">
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="ml-2 fill-black/50 hover:fill-black transition"
              >
